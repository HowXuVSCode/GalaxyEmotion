...
public enum Option {
    ...
    VERSION("--version -version", "opt.version", STANDARD, INFO) {
        ...
        public void process(OptionHelper helper, String option) throws InvalidValueException {
            ...
            System.out.println("");
            System.out.println("------------------------------------------------------------");
            System.out.println("GalaxyEmotion OpenJDK 17 JavaCompiler");
            System.out.println("------------------------------------------------------------");
            System.out.println("");
            System.out.println("Builder:           Howxu Technologies Studio");
            System.out.println("Fork name:         GalaxyEmotion");
            System.out.println("Description:       A deeply customized branch of OpenJDK based on the Alibaba DragonWell project.");
            System.out.println("");
            System.out.println("Build time:        2023-10-1 12:12:35 UTC  Happy Holiday! :)");
            System.out.println("Compiler version:  " + JavaCompiler.version());
            System.out.println("------------------------------------------------------------");
    ...
    FULLVERSION("--full-version -fullversion", null, HIDDEN, INFO) {
        ...
        public void process(OptionHelper helper, String option) throws InvalidValueException {
            ...
            System.out.println("");
            System.out.println("------------------------------------------------------------");
            System.out.println("GalaxyEmotion OpenJDK 11 JavaCompiler");
            System.out.println("------------------------------------------------------------");
            System.out.println("");
            System.out.println("Builder:           Howxu Technologies Studio");
            System.out.println("Fork name:         GalaxyEmotion");
            ...
            System.out.println("");
            System.out.println("Build time:        2023-10-1 12:12:35 UTC  Happy Holiday! :)");
            System.out.println("Full version:      " + JavaCompiler.fullVersion());
            System.out.println("------------------------------------------------------------");
            super.process(helper, option);
        }
    },
